...
class UpdateActor extends Component {
    ...
    updateActor = (e) => {
        ...
        if (this.state.name) {
            ...
            if (nameVerify) {
                data.name = name;
                AxiosChangeNameActorFilms(this.props.actor.name, name)
                .then(res => {
                    console.log('Error:', res.error);
                });
            } else {
                SweetModal('info', 'El nombre ingresado no es válido');
            }
        }
        if (this.state.dateOfBirth) {
            ...
            if (dateOfBirthVerify) {
                ...
                SweetModal('info', 'La fecha ingresada no es válida');
            }
        }
        if (this.state.gender) {
            ...
            if (genderVerify) {
                ...
                SweetModal('info', 'El sexo ingresado no es válido');
            }
        }
